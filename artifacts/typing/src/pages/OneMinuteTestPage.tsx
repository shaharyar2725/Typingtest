    ...
    <div className="container max-w-screen-lg mx-auto px-5 md:px-8 py-10 md:py-14">
      ...
      <article className="max-w-3xl mx-auto prose dark:prose-invert mt-12">
        ...
        <ul>
          ...
          <li><strong>Programmers:</strong> 50–70 WPM — accuracy-first mindset, code symbols slow the average</li>
          <li><strong>Writers/journalists:</strong> 65–90 WPM — typing to keep pace with thought</li>
          <li><strong>Professional typists:</strong> 65–80 WPM — deliberate skill; what most employer tests target</li>
        ...
        <p>
          ...
          keys — letting it stray means every new key becomes a decision instead of a reflex. The bumps on F
