...
export default function AboutPage() {
  useSEO({
    ...
    description:
      'TakeTypingTest is a free, minimalist typing practice platform with a live WPM typing test, a 10-lesson touch-typing course, and no ads. No signup required.',
    keywords:
      'about taketypingtest, typing test platform, free typing test, touch typing course, typing practice app',
    canonical: PAGE_URL,
    jsonLd: [
      {
  ...
  return (
    <div className="container max-w-3xl mx-auto px-5 md:px-8 py-12 md:py-16">
      <h1 className="text-4xl font-bold tracking-tight mb-8">About TakeTypingTest</h1>

      <div className="prose dark:prose-invert prose-lg max-w-none">
        <p>
          TakeTypingTest is a free online typing practice and typing test platform built around a
        ...
        <p>
          Speed comes from accuracy. That's why TakeTypingTest's{' '}
